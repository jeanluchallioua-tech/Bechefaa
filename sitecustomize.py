...
# 3) PostgreSQL persistant quand l'add-on Clever Cloud est lié
...
# L'ordre est important : app.py doit d'abord utiliser dbcompat, puis recevoir
# les autres ajustements. Gunicorn charge ce fichier avant d'importer app.py.
