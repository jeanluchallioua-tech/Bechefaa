...
Permet un règlement total ou partiel avec Espèces, CB ou Titre restaurant.
Le backend reste la source de vérité pour les montants et statuts.
"""
...
.p43-methods{display:grid;grid-template-columns:repeat(2,1fr);gap:10px}.p43-method{min-height:68px;border:2px solid #d0d5dd;border-radius:12px;background:#fff;font-size:17px;font-weight:900;cursor:pointer}.p43-method.active{border-color:#111827;background:#111827;color:#fff}
.p43-cash{display:none;margin-top:14px;padding:14px;border:1px solid #e4e7ec;border-radius:12px;background:#fafafa}.p43-cash.show{display:block}.p43-cash label{display:block;font-weight:900;margin-bottom:7px}.p43-cash input{width:100%;box-sizing:border-box;min-height:52px;border:1px solid #cfd4dc;border-radius:9px;padding:10px;font-size:20px;font-weight:800}.p43-change{margin-top:10px;font-weight:900;font-size:16px}.p43-error{min-height:22px;color:#b42318;font-weight:800;margin-top:10px}
...
<div id="p43-overlay" class="p43-overlay" aria-hidden="true">
  <div class="p43-modal" role="dialog" aria-modal="true" aria-labelledby="p43-title">
    ...
    <div class="p43-amount"><label for="p43-amount">Montant à encaisser</label><input id="p43-amount" inputmode="decimal" autocomplete="off"></div>
    ...
    <div id="p43-cash" class="p43-cash"><label for="p43-received">Montant reçu en espèces</label><input id="p43-received" inputmode="decimal" autocomplete="off"><div id="p43-change" class="p43-change"></div></div>
