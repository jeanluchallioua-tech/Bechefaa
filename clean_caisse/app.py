...
def ensure_pwa_static_assets():
    ...
    manifest = {
        ...
        "theme_color": "#0b0b0b",
        "icons": [
            {"src": "/static/pwa/icon-192.png?v=10", "sizes": "192x192", "type": "image/png", "purpose": "any"},
            {"src": "/static/pwa/icon-512.png?v=10", "sizes": "512x512", "type": "image/png", "purpose": "any"},
        ],
    }
