...
<link rel="icon" type="image/png" href="/caisse-icon.png?v=4">
...
<body>
<main class="card">
  <div class="logo"><img src="/caisse-icon.png?v=4" alt="BÉCHÉFAA Caisse" style="width:100%;height:100%;object-fit:contain;border-radius:20px"></div>
