...
Écrit uniquement dans catalog_admin_v2.products[].options.
Format canonique compatible avec le POS Phase 1 :
[{name, required, max, options:[{name, price}]}]
